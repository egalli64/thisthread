...
int main()
{
    ...
    {
        int const *pci = data + 2;
        std::cout << "The third element of data, " << data[2] << ", is pointed by pic, " << *pci << '\n';
        // *pci += 10;
        pci += 1;
        std::cout << "pci is a pointer to constant int, it can change, but its pointed can't: " << *pci << '\n';
    }
    ...
    {
        int const *const cpci = data + 2;
        std::cout << "The third element of data, " << data[2] << ", is pointed by cpic, " << *cpci << '\n';
        // *cpci += 10;
        // cpci += 1;
        std::cout << "cpci is a constant pointer to constant int, it can't change, as its pointed: " << *cpci << '\n';
    }
}